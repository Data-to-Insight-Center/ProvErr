...
package org.apache.pig.correct;
...
public class ABS extends EvalFunc<Double>{
    ...
    public List<FuncSpec> getArgToFuncMapping() throws FrontendException {
        ...
        funcList.add(new FuncSpec(org.apache.pig.correct.IntAbs.class.getName(),  new Schema(new Schema.FieldSchema(null, DataType.INTEGER))));

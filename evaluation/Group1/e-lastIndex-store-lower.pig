...
name_lower_lastIndex = FOREACH movies GENERATE LOWER(name), org.apache.pig.error.LAST_INDEX_OF(name,'a');

-- Use the  PigStorage function to store the results.
STORE name_lower_lastIndex INTO 'results' USING PigStorage();

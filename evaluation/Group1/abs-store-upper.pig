...
abs_upper_diff = FOREACH movies GENERATE org.apache.pig.correct.ABS(rating-3) as diff, UPPER(name) as upperName;

-- Use the  PigStorage function to store the results. 
-- Output: (diff, upperName)
STORE abs_upper_diff INTO 'abs-upper-upper-results' USING PigStorage();

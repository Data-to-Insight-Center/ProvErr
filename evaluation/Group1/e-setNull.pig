...
A_null = FOREACH A GENERATE a_id,org.apache.pig.error.SetCharArrayNull(a_name) as a_name,a_year,a_rating,a_duration;
...
C_null = JOIN A_null BY a_id, B_null BY b_id;

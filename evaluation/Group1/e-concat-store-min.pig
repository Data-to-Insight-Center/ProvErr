...
movies_concat = FOREACH movies GENERATE org.apache.pig.error.CONCAT(name,year) as strId, rating;
...
STORE movies_min INTO 'e-concat-store-min-results' USING PigStorage();
